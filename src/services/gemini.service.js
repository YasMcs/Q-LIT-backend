...
11. EVITAR COLISIONES DE LLAVE PRIMARIA EN INSERCIONES: Si uno de los objetivos o pasos de la práctica consiste en que el estudiante inserte un nuevo registro (operación INSERT), dicho registro específico (con su ID o llave primaria) NO debe ser pre-insertado en tu "setup_sql". Si lo haces, la consulta del estudiante fallará debido a una entrada duplicada. El "setup_sql" solo debe inicializar información de soporte relacionada (tablas secundarias, catálogos, llaves foráneas requeridas), pero nunca el registro exacto que el estudiante va a insertar en su ejercicio.
